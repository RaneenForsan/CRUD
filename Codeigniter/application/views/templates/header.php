			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="<?=base_url().'county' ?>" class=""><i class="lnr lnr-dice"></i> <span>Countries</span></a></li>
						<li><a href="<?=base_url().'logout' ?>" class=""><i class="lnr lnr-dice"></i> <span>Logout</span></a></li>
